...
print(f"\n{'='*64}")
print(f"  INCREMENTALITY ANALYSIS: Campaign Window (Weeks 88 to 95)")
print(f"{'='*64}")
...
print(f"  90% Credible Interval:                 [{ci_5:,.0f} to {ci_95:,.0f}]")
...
fig.suptitle(
    "StreamVista Subscriber Acquisition: Marketing Mix Model and Incrementality Analysis",
...
║    90% Credible Interval:          [{ci_5:,.0f} to {ci_95:,.0f}]   ║
║                                                              ║
